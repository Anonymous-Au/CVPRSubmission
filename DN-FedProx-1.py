...
def main(Location, dataset, method):
    ...
    previous_nets = [copy.deepcopy(models[idx]) for idx in range(0, client_num)]
...
if __name__ == '__main__':
    ...
    Location = './SavedModel/Food101/FedProx/lr=5e-5/pathological/'
    method = '/FedProx/lr=5e-5/pathological/'
    dataset = '/Food101/'
